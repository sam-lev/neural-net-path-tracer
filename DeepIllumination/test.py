...
root_dir = root_dir = '../path_tracer/raytracingtherestofyourlife/dataset/{}/test/'.format(opt.dataset)
image_dir = '../path_tracer/raytracingtherestofyourlife/dataset/{}/test/albedo'.format(opt.dataset)
